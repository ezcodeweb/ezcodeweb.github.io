...
// Colors
const BLUE =   { r: 0x68, g: 0xd7, b: 0xf0 };
const GREEN =  { r: 0xa6, g: 0xe0, b: 0x7c };
const PINK =   { r: 0x99, g: 0x99, b: 0x99 };
const ORANGE = { r: 0xfe, g: 0x93, b: 0x25 };
const allColors = [BLUE, GREEN, PINK, ORANGE];

// Gameplay
const getSpawnDelay = () => {
	const spawnDelayMax = 1500;
	const spawnDelayMin = 650;
...
function renderScoreHud() {
	...
	cubeCountNode.innerText = `BLOCK HIT: ${state.game.cubeCount}`;
}
