var sketchProc = function (processingInstance) {
  with (processingInstance) {
    ...
    var Button = function (config) {
      ...
      this.draw = function () {
        ...
        ellipse(
          ...
          (this.size + this.growth) * 0.8,
          (this.size + this.growth) * 0.3
        );
        ...
        if (dist(mouseX, mouseY, this.x, this.y) <= this.size / 2) {
          ...
          switch (this.content) {
            ...
            case "Back":
              ...
              line(
                this.x - this.size * 0.27,
                this.y - this.size * 0.05,
                this.x,
                this.y - this.size * 0.27
              );
              line(
                this.x + this.size * 0.27,
                this.y - this.size * 0.05,
            ...
            case "Replay":
              ...
              noStroke();
              fill(this.textColorHover);
              translate(this.size * 0.3, -this.size * 0.18);
              rotate(radians(-70));
              triangle(
                0,
                -this.size * 0.1,
    ...
    var AI = function (config) {
      ...
      this.segments = [];
      this.SPEED_MIN = config.SPEED_MIN || 6;
      this.SPEED_MAX = config.SPEED_MAX || 8;
      ...
      this.GEM_TIMER = config.GEM_TIMER || 320;
      this.gemTimer = config.gemTimer || 0;
      this.SPEED_TIMER = config.SPEED_TIMER || 350;
    ...
    AI.prototype.home = function () {
      ...
      var coordsArr =
        this.team === "GREEN"
          ? game.levels[game.level].coords.green
          : game.levels[game.level].coords.purple;
    ...
    AI.prototype.draw = function () {
      ...
      for (var i = 0; i < this.segments.length; i++) {
        ...
        image(
          this.spiritImg,
          segment.x - segment.w * 0.25,
          segment.y - segment.h * 0.25,
          segment.w,
          segment.h
        );
      }
    ...
    var Player = function (config) {
      ...
      this.angle = config.angle || 0;
      this.segments = [];
      this.SPEED_MIN = config.SPEED_MIN || 5;
      this.SPEED_MAX = config.SPEED_MAX || 8.5;
      this.speed = this.SPEED_MIN;
      this.dir = 0;
      this.moved = false;
      this.faceDir = 1;
      this.color = config.color;
      this.REACH_MIN = config.REACH_MIN || this.w * 0.75;
      this.REACH_MAX = config.REACH_MAX || this.w * 2;
      this.reach = this.REACH_MIN;
      this.GEM_TIMER = config.GEM_TIMER || 320;
      this.gemTimer = config.gemTimer || 0;
      ...
      this.speedTimer = config.speedTimer || 0;
      this.LIGHT_TIMER = config.LIGHT_TIMER || 350;
    ...
    var Game = function (config) {
      ...
      this.levels = [
        ...
        }, // menu
        {
          ...
          grid: [
            ...
            "B----G-G-G-G-G---BBBB---G-G-G-G-G----B",
            "B----G-G-G-G-G---BBBB---G-G-G-G-G----B",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
            ...
            "BGGGGGGGGGGGGGBBB----BBBGGGGGGGGGGGGGB",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
        ...
        }, // level1
        {
          ...
          grid: [
            "BBBBBBBBBBBBBBBBBB  BBBBBBBBBBBBBBBBBB",
            "B----G-G-G-G-G---BBBB---G-G-G-G-G----B",
            "B----G-G-G-G-G---GGGG---G-G-G-G-G----B",
            "B----G-G-G-G-G---GGGG---G-G-G-G-G----B",
            "B----G-G-G-G-G---BGGB---G-G-G-G-G----B",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
            "B-----B--G-G---G-G--G-G---G-G--B-----B",
            "B-G---B------------------------B---G-B",
            "B-----B----BBB---G-G----BBB----B-----B",
            ...
            "B-G--------------GGGG--------------G-B",
            "B----------------GGGG----------------B",
            "B---GGGGGGGGGGGGGBGGBGGGGGGGGGGGGG---B",
            "B---BFFFFFB----------------BEEEEEB---B",
            "B---FFF2FFF----------------EEE6EEE---B",
            "B---FF1F3FF--G-G-G--G-G-G--EE5E7EE---B",
            "B---FFF4FFF----------------EEE8EEE---B",
            "B---BFFFFFB----------------BEEEEEB---B",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
            ...
            "B----------------G--G----------------B",
            "B----------G--B--------B--G----------B",
            "BBB---BBB-----B--G--G--B-----BBB---BBB",
            "BGGGGGGGB--G--B--------B--G--BGGGGGGGB",
            "BGGGGGGGB-----B--G--G--B-----BGGGGGGGB",
            "BGGGGGGGG--G--B--------B--G--GGGGGGGGB",
            "BGGGGGGGG-----B--G--G--B-----GGGGGGGGB",
            "BBB---BBB--G--B--------B--G--BBB---BBB",
            "BGGGGGGGGGGGGGBBB----BBBGGGGGGGGGGGGGB",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
            "BGGGGGGGGGGGGGBGGGGGGGGBGGGGGGGGGGGGGB",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
            "BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB",
            "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB"
          ]
        },//level2
        {
          ...
          grid: [
            ...
            "B----B--B----------------------B--B----B",
            "B-G--BGGB--G----------------G--BGGB--G-B",
            "B----BGGB-----BBBBBBBBBBBB-----BGGB----B",
            "B-G--BBBB--G--B          B--G--BBBB--G-B",
            "B-------------B          B-------------B",
            "B-G-G-G-G-----BBBBBBBBBBBB-----G-G-G-G-B",
            "B-------G--G--G-G-G--G-G-G--G--G-------B",
            "B-------G--G--G-G-G--G-G-G--G--G-------B",
            "BBBBBGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGBBBBB",
            "    B------------------------------B    ",
            "    B--G------------------------G--B    ",
            "    B-----BFFFFBGGGGGGGGBEEEEB-----B    ",
            "    B--G--FFFFFFGGGGGGGGEEEEEE--G--B    ",
            "    B-----FF1F2FGGGGGGGGE5E6EE-----B    ",
            "    B--G--FFFFFF--------EEEEEE--G--B    ",
            "    B-----FF4F3FGGGGGGGGE7E8EE-----B    ",
            "    B--G--FFFFFFGGGGGGGGEEEEEE--G--B    ",
            "    B-----BFFFFBGGGGGGGGBEEEEB-----B    ",
            "    B--G------------------------G--B    ",
            "    B------------------------------B    ",
            ...
            "B--------------------------------------B",
            "B-G--B--B--G--BBBBBBBBBBBB--G--B--B--G-B",
            "B----BGGB-----B          B-----BGGB----B",
            "B-G--BGGB--G--B          B--G--BGGB--G-B",
            "B----BGGB-----BBBBBBBBBBBB-----BGGB----B",
            "B-G--B--B--G----------------G--B--B--G-B",
            "B--------------------------------------B",
        ...
        }, // level3
        {
          ...
          grid: [
            ...
            "B-G-G-G-G-G-G-G--G-G-G--G-G-G-G-G-G-G-B",
            "B-G--BBBB----G---BGGGB---G----BBBB--G-B",
            "B-----GG---------BGGGB---------GG-----B",
            "B-G---GG-----G---BGGGB---G-----GG---G-B",
            "B-----GG---------BGGGB---------GG-----B",
            "B-G--BBBB----G---BGGGB---G----BBBB--G-B",
            "B-G-G-G-G-G-G-G--BGGGB--G-G-G-G-G-G-G-B",
            "B-G-G-G-G-G-G-G--BGGGB--G-G-G-G-G-G-G-B",
            "B-G-G-G-G-G-G-G--BGGGB--G-G-G-G-G-G-G-B",
            "BBBBBB-------G---G-G-G---G-------BBBBBB",
            "BBBBBB-------G---G-G-G---G-------BBBBBB",
            "     B-G-G-G-G-BBBBBBBBB-G-G-G-G-B     ",
            "     B-G-G-G-G-G-G-G-G-G-G-G-G-G-B     ",
            "     B-G-G-G-G-G-G-G-G-G-G-G-G-G-B     ",
            "     B-G-G-G-G-G-G-G-G-G-G-G-G-G-B     ",
            "     B-G-G-G-G-G-G-G-G-G-G-G-G-G-B     ",
        ...
        }, //level4
        {
          ...
          grid: [
            ...
            "B-G-G-G-G-G-G-G-G-G-G-G-G-G-G-G-G-G-G-B",
            "B-------G----BFFFFFBEEEEEB----G-------B",
            "BB--BB-------BF1F2FBE5E6EB-------BB--BB",
            "BGGGGB--G----BFFFFFBEEEEEB----G--BGGGGB",
            "BGGGGG-------BF4F3FBE7E8EB-------GGGGGB",
            "BGGGGB--G----BFFFFFBEEEEEB----G--BGGGGB",
            "BB--BB---------------------------BB--BB",
            "B-G-G-G-G-G-G-G--G-G-G--G-G-G-G-G-G-G-B",
            "B-G-G-G-G-G-G-G--G-G-G--G-G-G-G-G-G-G-B",
            "B-G--BBBB----G----GGG----G----BBBB--G-B",
            "B-----GG----------GGG----------GG-----B",
            "B-----GG----------GGG----------GG-----B",
            "B-G--BBBB----G----GGG----G----BBBB--G-B",
            "B-G-G-G-G-G-G-G--BGGGB--G-G-G-G-G-G-G-B",
            "B-G-G-G-G-G-G-G--BGGGB--G-G-G-G-G-G-G-B",
            "BBBBBB-------G---G-G-G---G-------BBBBBB",
            "     B-G-G-G-G-BBB---BBB-G-G-G-G-B     ",
            "     B-G-G-G-G-G-G-G-G-G-G-G-G-G-B     ",
            "     B-G-G-G-G-G-G-G-G-G-G-G-G-G-B     ",
            "     B-----BBBB---------BBBB-----B     ",
            "     B-G-G-BGGB--G-G-G--BGGB-G-G-B     ",
            "     B---------------------------B     ",
            "     B---------------------------B     ",
            "     B-----BBBB---------BBBB-----B     ",
            "     BBBBBBB  BBBBBBBBBBB  BBBBBBB     "
      ...
      this.timer = 0;
      this.TOTAL_TIME = 130; // 130; //125 seconds (5 seconds for delay)
      this.timerStart = 0;
      ...
      this.aboutme = function () {
        ...
        image(
          this.images.spiderPurple,
          500 - this.images.spiderPurple.width,
          50 + cos(this.rate * 2) * 20
        );
        ...
        fill(255, 220);
        text(
          'This is the game take idea from Google Doodle halloween game. Base to the act of that game, I have create a new funny and smart game. By some side, this game can be help for your brain, because we must have a nice plan to get much flames, points without let the otherside take your flames and it must be on time to get your flame to your base.\n\nHope you have some funny time\n\nCreate by Hai Dang.\n\nEmail: phongson0812@gmail.com',
          40,
          160,
          520,
          600
      ...
      this.setup = function () {
        ...
        for (var i = 0; i <= 5; i++) {
          ...
          var x = bezierPoint(
            this.curveScores.x1,
            this.curveScores.cx1,
            this.curveScores.cx2,
            this.curveScores.x2,
            t
          );
          var y = bezierPoint(
            this.curveScores.y1,
            this.curveScores.cy1,
            this.curveScores.cy2,
            this.curveScores.y2,
            t
          );
          var tx = bezierTangent(
        ...
        this.images = {
          ground: function () {
            ...
            for (var i = 0; i < 20; i++) {
              stroke(250, i / 10);
              ellipse(
                ~~random(game.BLOCK_SIZE),
                ~~random(game.BLOCK_SIZE),
                game.BLOCK_SIZE * 0.05,
                game.BLOCK_SIZE * 0.05
              );
            }
            popStyle();
          ...
          lightSpirit: function () {
            ...
            var lightSpirit = new Spirit({
              headColor: color(182, 236, 182, 70),
              bodyColor: color(167, 209, 167, 150),
              bodyStroke: color(144, 212, 144, 70)
            });
            lightSpirit.draw();
          ...
          scoresTitle: function () {
            ...
            bezier(
              game.curveScores.x1,
              game.curveScores.y1,
              game.curveScores.cx1,
              game.curveScores.cy1,
              game.curveScores.cx2,
              game.curveScores.cy2,
              game.curveScores.x2,
              game.curveScores.y2
            );
      ...
      this.collisionX = function (obj1, obj2) {
        if (
          obj1.x + obj1.w > obj2.x &&
          obj1.py + obj1.h > obj2.y &&
          obj1.x < obj2.x + obj2.w &&
          obj1.py < obj2.y + obj2.h
        ) {
          return true;
        }
        return false;
      ...
      this.collisionY = function (obj1, obj2) {
        if (
          obj1.px + obj1.w > obj2.x &&
          obj1.y + obj1.h > obj2.y &&
          obj1.px < obj2.x + obj2.w &&
          obj1.y < obj2.y + obj2.h
        ) {
          return true;
        }
      ...
      this.collisionGem = function (player, gem) {
        if (
          player.x + player.w + player.reach > gem.x &&
          player.y + player.h + player.reach > gem.y &&
          player.x - player.reach < gem.x + gem.w &&
          player.y - player.reach < gem.y + gem.h
        ) {
          return true;
        }
        return false;
      ...
      this.isInView = function (obj) {
        if (
          obj.x + this.cam.x < 600 &&
          obj.x + this.cam.x + obj.w > 0 &&
          obj.y + this.cam.y < 600 &&
          obj.y + this.cam.y + obj.h > 0
        ) {
          return true;
        }
        return false;
          ...
          for (var i = 0; i < this.friends.length; i++) {
            ...
            if (friend.segments.length < 6) {
              ...
              if (closest < 10000) {
                ...
                friend.angle = atan2(
                  targetGem.y - friend.y,
                  targetGem.x - friend.x
                );
          ...
          for (var i = 0; i < this.friendBases.length; i++) {
            if (this.collision(this.player, this.friendBases[i])) {
              ...
              for (var j = 0; j < this.player.segments.length; j++) {
                ...
                var angle = atan2(
                  this.player.y + this.player.h / 2 - segment.y,
                  this.player.x + this.player.w / 2 - segment.x
                );
            ...
            for (var j = 0; j < this.friendBases.length; j++) {
              if (this.collision(friend, this.friendBases[j])) {
                ...
                for (var j = 0; j < friend.segments.length; j++) {
                  ...
                  var angle = atan2(
                    friend.y + friend.h / 2 - segment.y,
                    friend.x + friend.w / 2 - segment.x
                  );
            ...
            for (var j = 0; j < this.foeBases.length; j++) {
              if (this.collision(foe, this.foeBases[j])) {
                ...
                for (var j = 0; j < foe.segments.length; j++) {
                  ...
                  var angle = atan2(
                    foe.y + foe.h / 2 - segment.y,
                    foe.x + foe.h / 2 - segment.x
                  );
      ...
      this.runSpirits = function () {
        for (var i = this.spirits.length - 1; i >= 0; i--) {
          ...
          image(
            spirit.img,
            spirit.x - spirit.w * 0.25,
            spirit.y - spirit.h * 0.25,
            spirit.w,
            spirit.h
          );
        ...
        for (var i = 0; i < this.foes.length; i++) {
          ...
          for (var j = 0; j < this.player.segments.length; j++) {
            ...
            if (this.collision(foe, segment)) {
              var gemArr = this.player.segments.splice(
                j,
                this.player.segments.length - j
              );
          ...
          for (var f = 0; f < this.friends.length; f++) {
            ...
            for (var j = 0; j < friend.segments.length; j++) {
              ...
              if (this.collision(foe, segment)) {
                var gemArr = friend.segments.splice(
                  j,
                  friend.segments.length - j
                );
      ...
      this.displayPointsCollected = function () {
        ...
        for (var i = this.notifsPoints.length - 1; i >= 0; i--) {
          ...
          text(
            this.notifsPoints[i].content,
            this.notifsPoints[i].x,
      ...
      this.pointsBar = function () {
        ...
        if (this.points.friend + this.points.foe === 0) {
          ...
          rect(
            ...
            10,
            map(
              this.points.friend / (this.points.friend + this.points.foe),
              0,
              1,
              0,
              400
          ...
          rect(
            ...
            10,
            map(
              this.points.foe / (this.points.friend + this.points.foe),
              0,
              1,
              0,
              400
      ...
      this.move = function (arr) {
        if (this.player.moved) {
          ...
          for (var i = 0; i < arr.length; i++) {
            ...
            if (block.x + block.w < this.player.x) {
              continue;
            }
            if (block.x > this.player.x + this.player.w) {
              continue;
            }
            if (block.y + block.h < this.player.y) {
              continue;
            }
            if (block.y > this.player.y + this.player.h) {
              continue;
            }

            //check x only if moved horizontally
            if (
              this.player.x !== this.player.px &&
              this.collisionX(this.player, block)
            ) {
            ...
            if (
              ...
              this.collisionY(this.player, block)
            ) {
      ...
      this.light = function () {
        ...
        for (var i = 0; i < 10; i++) {
          ...
          ellipse(
            ...
            width + i * this.player.lightRadius,
            height + i * this.player.lightRadius
          );
        }
        popStyle();
        //}
      ...
      this.stats = function () {
        ...
        this.points.friend =
          this.player.points +
          this.friends[0].points +
          this.friends[1].points +
          this.friends[2].points;
        this.points.foe =
          this.foes[0].points +
          this.foes[1].points +
          this.foes[2].points +
        ...
        if (
          this.timer > this.TOTAL_TIME - 10 &&
          this.timer < this.TOTAL_TIME - 5
        ) {
          pushStyle();
          textFont(this.fonts.title);
          textAlign(CENTER, CENTER);
      ...
      this.run = function () {
        ...
        if (
          this.counter %
            ~~random(this.addGemFrequency - 30, this.addGemFrequency + 30) ===
            0 &&
          this.numberOfGems < this.gems.length
        ) {
          this.addGem();
          this.numberOfGems++;
        }
      ...
      this.home = function () {
        ...
        if (this.rate % 120 === 0) {
          ...
          if (this.playColor === 1) {
            this.buttons.play.textColor = color(this.COLORS.green);
          } else {
            this.buttons.play.textColor = color(this.COLORS.purple);
          }
        }
      ...
      this.how = function () {
        ...
        fill(255, 220);
        text(
          'You will get team up with three another ghost.\n\nIn 125 second, you will be able to use arrow key or WASD to move and get the flames\n\nYou will get points for the spirit flames by getting them back to your base.\n\nNote that different spirit flames give you varying abilities.',
          40,
          160,
          520,
          600
      ...
      this.scoreboard = function () {
        ...
        image(
          this.images.spiderPurple,
          520 - this.images.spiderPurple.width,
          50 + cos(this.rate * 2) * 20
        );
      ...
      this.gameover = function () {
        ...
        if (this.points.friend > this.points.foe) {
          if (this.player.team === "GREEN") {
            image(
              this.images.spiderGreen,
              300 - this.images.spiderGreen.width / 2,
              160 + sin(this.rate) * 30
            );
          } else {
            image(
              this.images.spiderPurple,
              300 - this.images.spiderPurple.width / 2,
              160 + sin(this.rate) * 30
            );
          }
        } else {
        ...
        fill(255, 150);
        text(
          this.player.index < 4 ? this.points.friend : this.points.foe,
          125,
          195
        );
        ...
        fill(255, 150);
        text(
          this.player.index > 3 ? this.points.friend : this.points.foe,
          475,
          195
        );
